...
const index = () => {
  ...
  return (
    <>
      <h1 className={projectStyle.main_title}>Portfolio</h1>
      <motion.div
        ...
        <div className={`${projectStyle.box} `}>
          <div className={projectStyle.project_description}>
            ...
            <p className={projectStyle.description}>
              ...
              The user will be asked to input a username, email, and password.
              The application uses AJAX for database authentication to check if
              the username and email address is not already in use. It also has
              a password requirement of a length, case, and number.It was
